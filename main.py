...
#load the database
symptoms = pd.read_csv('trinity/datasets/symtoms_df.csv')
precautions = pd.read_csv('trinity/datasets/precautions_df.csv')
workout = pd.read_csv('trinity/datasets/workout_df.csv')
description = pd.read_csv('trinity/datasets/description.csv')
medications = pd.read_csv('trinity/datasets/medications.csv')
diets = pd.read_csv('trinity/datasets/diets.csv')

#load the model
svc = pickle.load(open('trinity/models/svc.pkl', 'rb'))
